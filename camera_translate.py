...
class ThaiSignTranslator:
    ...
    def _get_cached_font(self, size, font_paths=None):
        """Get or load a font from cache."""
        cache_key = f"{size}_{','.join(font_paths) if font_paths else 'default'}"
    ...
    def run(self):
        ...
        while True:
            ...
            if self.current_prediction:
                ...
                # Use slightly smaller default size if custom fonts fail (as per original logic)

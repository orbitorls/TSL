...
class ThaiSignTranslator:
    ...
    def _get_cached_font(self, font_size):
        """Get or create a cached font of the specified size.

        ⚡ Bolt Optimization:
        Caches PIL ImageFont objects to prevent expensive disk I/O and
        parsing overhead on every frame, improving overall FPS.
        """

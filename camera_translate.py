...
class ThaiSignTranslator:
    ...
    def _get_cached_font(self, font_size, is_thai=True):
        """Get cached font to avoid disk I/O in the render loop."""
        cache_key = (font_size, is_thai)
    ...
    def _draw_thai_text(self, frame, text, pos, font_size=60, color=(255, 255, 255), bg_color=None):
        ...
        font = self._get_cached_font(font_size, is_thai=True)
    ...
    def run(self):
        ...
        while True:
            ...
            if self.current_prediction:
                ...
                font = self._get_cached_font(80, is_thai=True)
                conf_font = self._get_cached_font(30, is_thai=True)
                ...
                if features and len(features) == len(self.mean):
                    ...
                    if normalized:
                        ...
                        for index, (label_index, conf) in enumerate(zip(top3_idx, top3_conf)):
                            ...
                            font = self._get_cached_font(22, is_thai=True)

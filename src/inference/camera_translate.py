...
class ThaiSignTranslator:
    def __init__(self, model_path="models/tsl_model.pt", feature_level=None):
        ...
        # Cache for fonts to avoid disk I/O in render loop
        self._font_cache = {}
    ...
    def _get_cached_font(self, font_size, font_paths=None):
        """Retrieve a font from cache or load it if not present to avoid disk I/O."""
        ...
        # Using a tuple of paths as part of the key makes it immutable and safe for caching

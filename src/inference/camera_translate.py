...
class ThaiSignTranslator:
    ...
    def _get_cached_font(self, font_size, default_size=None, font_paths=None):
        """Get a cached font to avoid redundant disk I/O in the hot loop."""
    ...
    def _draw_thai_text(self, frame, text, pos, font_size=60, color=(255, 255, 255), bg_color=None):
        ...
        font = self._get_cached_font(font_size, font_size, font_paths)
    ...
    def run(self):
        ...
        while True:
            ...
            if self.current_prediction:
                ...
                font = self._get_cached_font(80, 60, font_paths)
                conf_font = self._get_cached_font(30, 25, font_paths)
            ...
            if len(self.sequence_buffer) >= min_frames:
                ...
                if features is not None and normalized is not None and tensor is not None:
                    ...
                    for index, (label_index, conf) in enumerate(zip(top3_idx, top3_conf)):
                        ...
                        font_paths = ["C:/Windows/Fonts/tahoma.ttf", "C:/Windows/Fonts/phagspa.ttf"]
                        font = self._get_cached_font(22, 18, font_paths)

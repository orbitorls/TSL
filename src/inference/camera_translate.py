...
class ThaiSignTranslator:
    ...
    def _get_cached_font(self, font_size, font_paths=None):
        """Retrieve a cached PIL ImageFont, avoiding repeated file I/O."""
        cache_key = (font_size, tuple(font_paths) if font_paths else None)
        ...
        if font is None:
            try:
                ...
                # Fallback to older load_default signature if necessary

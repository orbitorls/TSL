...
class ThaiSignTranslator:
    ...
    def _get_cached_font(self, font_size, font_paths=None):
        """Get or load a font from cache to avoid disk I/O in render loop."""
        ...
        cache_key = (font_size, font_paths)
    ...
    def run(self):
        ...
        while True:
            ...
            if self.current_prediction:
                ...
                font_paths_80 = ("C:/Windows/Fonts/tahoma.ttf", "C:/Windows/Fonts/phagspa.ttf")
                font_paths_30 = ("C:/Windows/Fonts/tahoma.ttf", "C:/Windows/Fonts/phagspa.ttf")

                font = self._get_cached_font(80, font_paths_80)
                conf_font = self._get_cached_font(30, font_paths_30)
            ...
            if len(self.sequence_buffer) >= min_frames:
                ...
                if features is not None and normalized is not None and tensor is not None:
                    ...
                    for index, (label_index, conf) in enumerate(zip(top3_idx, top3_conf)):
                        ...
                        font_paths_22 = ("C:/Windows/Fonts/tahoma.ttf", "C:/Windows/Fonts/phagspa.ttf")
                        font = self._get_cached_font(22, font_paths_22)

...
class ThaiSignTranslator:
    ...
    def _get_cached_font(self, font_size, font_paths=None, default_size=None):
        """Retrieve a cached PIL ImageFont or load and cache it."""
        ...
        # Use immutable types for cache key
        ...
        if font is None:
            load_size = default_size if default_size is not None else font_size
            font = ImageFont.load_default(size=load_size)
    ...
    def run(self):
        ...
        while True:
            ...
            if self.current_prediction:
                ...
                font_paths_primary = ["C:/Windows/Fonts/tahoma.ttf", "C:/Windows/Fonts/phagspa.ttf"]
                font = self._get_cached_font(80, font_paths=font_paths_primary, default_size=60)
                conf_font = self._get_cached_font(30, font_paths=font_paths_primary, default_size=25)
            ...
            if len(self.sequence_buffer) >= min_frames:
                ...
                if features is not None and normalized is not None and tensor is not None:
                    ...
                    for index, (label_index, conf) in enumerate(zip(top3_idx, top3_conf)):
                        ...
                        font_paths_sidebar = ["C:/Windows/Fonts/tahoma.ttf", "C:/Windows/Fonts/phagspa.ttf"]
                        font = self._get_cached_font(22, font_paths=font_paths_sidebar, default_size=18)

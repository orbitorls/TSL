...
def _build_column_list(feature_level: str = "basic") -> list[str]:
    ...
    # ⚡ Bolt: cache column lists to eliminate redundant string formatting and lookups
...
def extract_features_from_landmark_df(lm_df: Any, feature_level: str = "basic") -> np.ndarray:
    ...
    # ⚡ Bolt: vectorized optimization using cached columns to eliminate overhead
...
def extract_sequence_from_landmark_df(
    ...
    # ⚡ Bolt: bulk assignment optimization

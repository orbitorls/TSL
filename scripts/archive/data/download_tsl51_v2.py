        ...
        with zipfile.ZipFile(zip_path, 'r') as z:
            for idx, row in tqdm(non_aug.iterrows(), total=len(non_aug), desc=f"{source_name}"):
                ...
                try:
                    ...
                    # Extract 162 features using shared utility
                    from src.data.feature_extraction import extract_features_from_landmark_df
                    features = extract_features_from_landmark_df(lm_df, feature_level='basic')
